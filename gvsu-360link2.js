setTimeout(function() {
	jQuery(document).ready(function() {
		...
		jQuery('div.resource-row:contains("Browse the online journal by issue or volume")').css('font-weight', 'bold').css('font-size', '1.2em').text('Full text may be available by browsing journals by volume and issue').find('a').css('font-size','.9em').next('.resource-description-text').css('font-weight','normal').css('font-size','.8em');
